...
public class IntentShim extends CordovaPlugin
{
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext)
    {
        try
        {
            ...
            else if (action.equals("packageExists"))
            {
                ...
                callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, checkPackageExists(packageName)));
            }
            return true;
        }
        catch (Exception e) {
    ...
    private String getRealPathFromURI_API19(JSONObject obj, CallbackContext callbackContext)
    {
        ...
        if (uri == null)
        {
            ...
            throw new RuntimeException("URI is not a specified parameter");
        }
